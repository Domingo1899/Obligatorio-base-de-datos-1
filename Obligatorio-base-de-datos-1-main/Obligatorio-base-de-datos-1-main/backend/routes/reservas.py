...
def crear_reserva():
    ...
    try:
        ...
        # REGLA 1: Sala posgrado solo para posgrado o docente
        if tipo_sala == "posgrado" and tipo_programa == "grado":
            return jsonify({"error": "La sala es exclusiva para estudiantes de posgrado"}), 403

        # REGLA 2: Sala docente solo para docentes
        if tipo_sala == "docente" and rol != "docente":
